...
import {
    IconBrandFacebook, IconBrandInstagram, IconBrandLinkedin, IconMail, IconPhone
  ...
  return (
    <footer className="p-4 bg-white md:p-8 lg:p-10 border-t">
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <div className="my-6 text-gray-500 flex flex-row gap-4 items-center justify-center">
          <IconBrandFacebook />
          <IconBrandInstagram />
          <IconBrandLinkedin />
          <IconMail />
